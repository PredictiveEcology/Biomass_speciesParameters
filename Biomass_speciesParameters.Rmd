...
modules <- list("Biomass_speciesParameters", "PSP_Clean")
...
inputSpecies <- data.table(species = c("Abie_bal", 'Abie_las', 'Betu_pap', 'Lari_lar',
                           ...
                           longevity = c(300, 300, 160, 160, 330, 250, 200, 150, 250, 300, 200),
...
parameters <- list(
  Biomass_speciesParameters = 
    list(GAMMiterations = 2, 
         ...
         constrainMortalityShape = c(8, 25), #it is possible to pass a named list here too
         constrainGrowthCurve = c(0, 1),
         constrainMaxANPP = c(3.0, 3.5),
         quantileAgeSubset = list(
           "Abie_bal" = 98, #N = 43 w/ 95 subset
           "Abie_las" = 98, #N = 300 '' 
           "Betu_pap" = 95, #N = 143 95
           "Lari_lar" = 95, #N = 64 #don't use 99, 
           "Pice_eng" = 97,
           "Pice_gla" = 98, #N = 1849 95
           "Pice_mar" = 95, #N = 785 95
           "Pinu_ban" = 98, #N = 645
           "Pinu_con" = 99, # N = 3172,
